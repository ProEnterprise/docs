...
<!--markdown-->
Before we venture to learn form customization tool, click [here](https://frappe.io/docs/user/en/tutorial/doctypes.html) to understand the architecture of forms in Pro Enterprise ERP. It shall help you in using Customize Form tool more efficiently.

Customize Form is the tool which allows user to customize property of the standard fields, and insert [custom fields](/docs/user/manual/en/customize-ProEnterprise/custom-field.html) as per the requirement. Let's assume we need to set Project Name field as a mandatory field in the Sales Order form. Following are the steps which shall be followed to achieve this.
...
* Change [Field Type](/docs/user/manual/en/customize-ProEnterprise/articles/field-types.html).
...
To have customizations take effect, reload your Pro Enterprise ERP account once.

####Other Customizations

From Customize Form, you can also do following customizations:

* Max Attachment Limit: Define [maximum no. of files](/docs/user/manual/en/customize-ProEnterprise/articles/increase-max-attachments.html) which can attached on a document.
...
* Set [Title Field](/docs/user/manual/en/customize-ProEnterprise/document-title.html)
...
<table border="1" width="700px">
  <tbody>
    ...
    <tr>
      <td>Field Type</td>
      <td>Click <a href="/docs/user/manual/en/customize-ProEnterprise/articles/field-types.html">here</a> to learn about of fields types.</td>
    </tr>
    <tr>
      <td>Options</td>
