...
While customizing rules in the [Permission Manager](/docs/user/ProEnterprise/user/manual/en/setting-up/users-and-permissions/role-based-permissions), you might receive an error message saying:
