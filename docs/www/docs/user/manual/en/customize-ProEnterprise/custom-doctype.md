...
DocType or a Document Type is a tool to insert form in Pro Enterprise ERP. The forms like Sales Order,
...
Custom Doctype allows you to insert custom forms in Pro Enterprise ERP as per your requirement.
