...
Some of the masters in Pro Enterprise ERP are maintained in tree structure. Tree structured masters allow you to set Parent master, and Child masters under those Parents. Setting up this structure allows you creating intelligent report, and track growth at each level in the hierarchy. 
...
Following this steps, you can manage other tree masters as well in Pro Enterprise ERP.
