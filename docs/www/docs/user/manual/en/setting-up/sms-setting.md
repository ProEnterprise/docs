...
To integrate SMS in Pro Enterprise ERP, approach a SMS Gateway Provider who provides HTTP
API. They will create an account for you and will provide an unique username
and password.

To configure SMS Settings in Pro Enterprise ERP, find out their HTTP API (a document
