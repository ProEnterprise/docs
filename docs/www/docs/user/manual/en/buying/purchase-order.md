...
In Pro Enterprise ERP, you can also make a Purchase Order directly by going to:
...
This is very easy to track in Pro Enterprise ERP since each tax head is also an Account.
