...
In Pro Enterprise ERP after making all the special entries via Journal Entry for the current fiscal year, you should set all your Income and Expense accounts to zero via:
