...
Project management in Pro Enterprise ERP is Task driven. You can create Project and assign multiple Tasks against it.
...
Pro Enterprise ERP uses [Time Log](/docs/user/manual/en/projects/time-log.html) to track the progress of a Project.
...
Pro Enterprise ERP gives you a illustrated view of tasks scheduled against that project in Gantt Chart View.
