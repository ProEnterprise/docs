...
taxes correctly, they get very unhappy. Ok, philosophy aside, Pro Enterprise ERP allows
...
<img class="screenshot" alt="Item Tax" src="/docs/assets/img/taxes/item-tax.png">
  ...
  * **Inclusive and Exclusive Tax**: Pro Enterprise ERP allows you to enter Item rates which are tax inclusive.
...
The way Pro Enterprise ERP sets up taxes is via templates. Other types of charges that
