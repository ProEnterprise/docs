...
#### How does Pro Enterprise ERP track stock movement / levels?
...
complications arise when:
  ...
  * Stock has to be valued based on First-in-First-out: Pro Enterprise ERP needs to maintain a sequence of all transactions to know the exact value of your Items.
...
To manage this, Pro Enterprise ERP collects all inventory transactions in a table called
