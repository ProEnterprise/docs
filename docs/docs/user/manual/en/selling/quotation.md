...
The rates you quote may depend on two things.
  ...
  * The Currency: If you are quoting to a Customer in a different currency, you will have to update the conversion rates to enable Pro Enterprise ERP to save the information in your standard Currency. This will help you to analyze the value of your Quotations in standard Currency.
...
the discount in percentage or fixed amount. Read [Discount](https://ProEnterprise.org/docs/user/manual/en/selling/articles/applying-discount) for more explanation.
