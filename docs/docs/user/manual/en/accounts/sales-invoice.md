...
Pro Enterprise ERP will automatically create new Invoices and mail it to the Email Addresses
you set.
...
Pro Enterprise ERP) titled as “Pro Forma Invoice”. This way everyone is happy.
