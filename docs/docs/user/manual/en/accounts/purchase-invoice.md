...
#### Update Stock
The **Update Stock** checkbox should be checked if you want Pro Enterprise ERP to automatically
...
If **Is Paid** is checked, Pro Enterprise ERP will also make the following
accounting entries:
