...
queries via email. For example, you can send support queries to Pro Enterprise ERP at
support@enterprise.plus.co.zm and it will automatically create a Issue in the
Frappé system.
