...
The terminology of 'Warehouse" in Pro Enterprise ERP is a bit broader though and maybe can be 
...
In Pro Enterprise ERP, every Warehouse must belong to a specific company, to maintain
...
> Note: Pro Enterprise ERP system maintains stock balance for every distinct combination
