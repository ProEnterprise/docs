...
### Fase de Prueba
  ...
  * Leer el manual
  * Crea una cuenta gratis en [https://enterprise.plus.co.zm](https://enterprise.plus.co.zm) (La forma más facíl de experimental).
...
Una vez ya estes falimiliarizado con Pro Enterprise ERP, inicia introduciendo la información real!
  ...
  * También puedes configurar una nueva cuenta en [https://enterprise.plus.co.zm](https://enterprise.plus.co.zm), y usa los 30 días gratis. [Encuentra mas formas de usar Pro Enterprise ERP](/introduction/getting-started-with-ProEnterprise)
  ...
  * Si necesitas ayuda, [puedes pagar por soporte](https://enterprise.plus.co.zm/pricing) o [preguntar en el foro de la comunidad](https://discuss.enterprise.plus.co.zm).
