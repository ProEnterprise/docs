...
Bevor Sie damit beginnen, Ihre Arbeiten über Pro Enterprise ERP abzuwickeln, müssen Sie sich zuerst mit dem System und den benutzten Begriffen vertraut machen. Aus diesem Grund empfehlen wir Ihnen, die Einführung in zwei Phasen durchzuführen:
...
* Legen Sie ein kostenloses Konto auf [https://enterprise.plus.co.zm](https://enterprise.plus.co.zm) an. (Das ist der einfachste Weg um zu experimentieren.)
...
Wenn Sie sich  mit Pro Enterprise ERP vertraut gemacht haben, beginnen Sie mit dem Eingeben der echten Daten!
...
* Sie können auch auf [https://enterprise.plus.co.zm](https://enterprise.plus.co.zm) ein neues Konto erstellen, und die Dreißig-Tage-Probezeit nutzen. [Finden Sie hier mehr zum Thema Einsatz von Pro Enterprise ERP heraus](/introduction/getting-started-with-ProEnterprise).
...
* Wenn Sie Hilfe benötigen, [können Sie sich Supportdienstleistungen kaufen](https://enterprise.plus.co.zm/pricing), oder [im Benutzerforum nachlesen](https://discuss.enterprise.plus.co.zm).
