...
Wenn Sie dann Ihre Analyse durchführen, haben Sie ein besseres Verständnis dafür, welches Ihrer Geschäfte besser läuft. Da Pro Enterprise ERP eine Option hat, mehrere verschiedene Firmen zu verwalten, können Sie für jede Firma eine Kostenstelle anlegen und getrennt verwalten.
...
Pro Enterprise ERP hilft Ihnen dabei, Budgets für Ihre Kostenstellen zu erstellen und zu verwalten. Dies ist dann nützlich, wenn Sie zum Beispiel Onlineverkäufe durchführen. Sie haben ein Budget für Werbung in Suchmaschinen und Sie möchten, dass Pro Enterprise ERP Sie warnt oder davon abhält, mehr auszugeben, als im Budget festgehalten wurde.
...
![Budgetverteilung](/docs/assets/old_images/ProEnterprise/budgeting.png)

### Budgetaktionen

Pro Enterprise ERP erlaubt es Ihnen:
